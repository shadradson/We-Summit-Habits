...
// Dark theme colors
val primaryDark = Color(0xFF67D3FD)
...
val StatTypeDuration = Color(0xFF9C27B0)  // Purple for duration
val StatTypeRating = Color(0xFFFFAB00)    // Amber for ratings
val StatTypeCheckbox = Color(0xFF4CAF50)  // Green for checkboxes
